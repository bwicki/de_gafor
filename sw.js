 ...
 */
const VERSION = 'gaforcast-v1.12.0';   // muss APP.cache in js/version.js entsprechen
const SHELL = [
  './', './index.html',
  './css/base.css', './css/app.css',
  './js/version.js', './js/util.js', './js/gafor.js', './js/geo.js', './js/dwd.js',
  './js/metar.js', './js/openmeteo.js', './js/wind.js', './js/stueve.js', './js/mapview.js', './js/app.js',
  './js/vendor/leaflet/leaflet.js', './js/vendor/leaflet/leaflet.css',
  './js/vendor/html2canvas.min.js',
  './data/gafor-areas.geojson', './data/gafor-meta.json',
  './data/gafor-regions.geojson', './data/germany.geojson',
